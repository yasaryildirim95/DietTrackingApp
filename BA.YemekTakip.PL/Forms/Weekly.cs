...
namespace BA.DietTrackApp.PL.Forms
{
    public partial class Weekly : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            // Son 7 gün içindeki öğünleri kullanıcı ve öğün tipine göre gruplayarak sorgula
            var data2 = foodMealManager.GetTablewMT().Where(x => x.Meal.Date <= mainForm.monthCalendar1.SelectionStart.Date && x.Meal.Date >= mainForm.monthCalendar1.SelectionStart.Date.AddDays(-7))
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            // Son 7 gün içindeki yemekleri kullanıcı ve yemek türüne göre gruplayarak sorgula
            var data2 = foodMealManager.GetTablewFT().Where(x => x.Meal.Date <= mainForm.monthCalendar1.SelectionStart.Date && x.Meal.Date >= mainForm.monthCalendar1.SelectionStart.Date.AddDays(-7))
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            // Son 7 gün içindeki yemekleri adlarına göre gruplayarak sorgula
            var data = foodMealManager.GetAllTable().Where(x => x.Meal.Date <= mainForm.monthCalendar1.SelectionStart.Date && x.Meal.Date >= mainForm.monthCalendar1.SelectionStart.Date.AddDays(-7))
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            // Son 7 gün içindeki yemekleri adlarına ve öğün türüne göre gruplayarak sorgula
            var data = foodMealManager.GetTablewMT().Where(x => x.Meal.Date <= mainForm.monthCalendar1.SelectionStart.Date && x.Meal.Date >= mainForm.monthCalendar1.SelectionStart.Date.AddDays(-7))
