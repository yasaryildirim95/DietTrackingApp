...
namespace BA.DietTrackApp.PL.Forms
{
    public partial class Snacks : Form
    {
        ...
        {
            // Ara öğün düğmesi devre dışı bırakılıyor.
            mainForm.buttonSnacks.Enabled = false;
            ...
            data2 = foodMealManager.GetTablewMT().Where(x => x.Meal.UserId == mainForm.tempint && x.Meal.Date == mainForm.monthCalendar1.SelectionStart.Date && x.Meal.MealType.Id == 4).ToList();
            ...
            var data3 = foodMealManager.GetTablewMT().Where(x => x.Meal.UserId == mainForm.tempint && x.Meal.Date == mainForm.monthCalendar1.SelectionStart.Date && x.Meal.MealType.Id == 4).Sum(x => x.Food.Calori);
        ...
        private void Snacks_FormClosed(object sender, FormClosedEventArgs e)
        {
